...
data = {
    "Name":"Majahar",
    "mailid":"majju123@gmail.com",
    "Gender":"Male",
    "subjents":["datascience","ML","DL"]
}
...
#creating database with Myinfo name
database = client["Myinfo"]

#creating the collection inside a database
collection = database["majahar"]
collection1 = database["majahar1"]

#The below lines to insert record into my collection name majahar
